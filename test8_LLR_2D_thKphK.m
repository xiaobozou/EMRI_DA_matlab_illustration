...
thK = (0:10)*delta;
phK = (-10:10)*delta;
[thK_2D,phK_2D] = meshgrid(thK,phK);
save('./Results/LLR_2D_thKphK.mat','LLR_2D','thK_2D','phK_2D');
figure(1)
pcolor(thK_2D,phK_2D,LLR_2D)
hold on
plot(1.522100180545765,3.946698166040000,'r+','MarkerSize',20,'LineWidth',5)
hold off
shading interp
set(gca,'fontsize',20);
c = colorbar;
...
sgt = sgtitle('Test 2D subspace ($\theta_k,\phi_k$), 2026/04/23','Color','k','FontSize',30,'Interpreter', 'latex');
saveas(gcf,'./Figures/test8_2D_landscape_thKphK.png')
